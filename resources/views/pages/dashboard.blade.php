                    ...
                    <a class="card lift h-100" href="#!">
                        <div class="card-body d-flex justify-content-center flex-column">
                            <div class="d-flex align-items-center justify-content-between">
                                ...
                                <img src="{{ url('backend/assets/img/illustrations/browser-stats.svg')}}" alt="..." style="width: 8rem" />
                            </div>
                        </div>
                    </a>
                </div>
                    ...
                    <a class="card lift h-100" href="#!">
                        <div class="card-body d-flex justify-content-center flex-column">
                            <div class="d-flex align-items-center justify-content-between">
                                ...
                                <img src="{{ url('backend/assets/img/illustrations/processing.svg')}}" alt="..." style="width: 8rem" />
                            </div>
                        </div>
                    </a>
                </div>
                    ...
                    <a class="card lift h-100" href="#!">
                        <div class="card-body d-flex justify-content-center flex-column">
                            <div class="d-flex align-items-center justify-content-between">
                                ...
                                <img src="{{ url('backend/assets/img/illustrations/windows.svg')}}" alt="..." style="width: 8rem" />
                            </div>
                        </div>
                    </a>
                </div>
